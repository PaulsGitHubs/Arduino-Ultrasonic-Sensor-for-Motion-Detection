...
void loop()
{
	...
	Serial.println(" cm");
      if (distance > 10) { // change to what is needed
        // Send an alert if the distance is more than 10 cm
        Serial.println("Alert: Distance is greater than 10 cm!");
        // Here you can add additional code to handle the alert,
        // send message through esp8266 through wifi internet to phone or other platform or device (need esp to do this)
    }
